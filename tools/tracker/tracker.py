...
import numpy as np
from tools import sort_vinit
# from sort_vinit import *
...
class Tracker:
    def __init__(self, kf_params, **kwargs):
        ...
        # Inserted tracker : https://github.com/abewley/sort/tree/master  
        # self._my_object_tracker = None
        # self._my_object_tracker = sort_vinit.Sort()
        self._my_object_tracker = sort_vinit.Sort(**kwargs)
    ...
    def push(self, boxes, scores):
        ...
        if len(result): 
            idxs = idx_maxima[idxs] # mapping back to original box indexes before nms
...
def track_vehicles( dets, categories=None, update_box=True, dbg=(), **kwargs):
    ...
    ## Creating a Tracker class per catagory
